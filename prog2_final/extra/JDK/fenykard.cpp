 ...
 *
 * UDPROG Elõadás jegymegajánlás alappontok:
 * $ ./fenykard --roots City/Debrecen/Oktatás/Informatika/Programozás/DEIK/Prog1/Példák/Elõadás City/Debrecen/Szórakozás/Könyv/Ismeretterjesztõ/Informatika City/Debrecen/Oktatás/Informatika/Programozás/Tankönyv\ olvasás City/Debrecen/Oktatás/Informatika/Programozás/UDPROG City/Debrecen/Szórakozás/Elõadás/Ismeretterjesztõ/Informatika City/Debrecen/Oktatás/Informatika/Programozás/Forráskód\ olvasás City/Debrecen/Oktatás/Informatika/Programozás/Forráskód\ írás City/Debrecen/Oktatás/Informatika/Programozás/API\ doksi\ olvasás City/Debrecen/Oktatás/Informatika/Programozás/DEIK/Prog1/Labor/Védés City/Debrecen/Szórakozás/Film -v
 *
 * UDPROG Elõadás jegymegajánlás tradicionális rangsor:
...
int main ( int argc, char *argv[] )
{
        ...
        */
        ...
        std::vector<std::string> def_ops_roots = {
                "City/Debrecen/Oktatás/Informatika/Programozás/DEIK/Prog1/Példák/Elõadás",
                "City/Debrecen/Szórakozás/Könyv/Ismeretterjesztõ/Informatika",
